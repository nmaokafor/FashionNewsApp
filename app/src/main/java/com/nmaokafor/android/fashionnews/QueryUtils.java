...
public class QueryUtils {
    ...
    static String createStringUrl() {
        ...
        builder.scheme("https")
                ...
                .appendQueryParameter("show-tags", "contributors")
                .appendQueryParameter("show-references", "author")
                .appendQueryParameter("q", "Fashion")
    ...
    static List<Fashion> parseJson(String response) {
        ArrayList<Fashion> listOfFashionNews = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                listOfFashionNews.add(new Fashion(section, webTitle, author, url, date));
            }
